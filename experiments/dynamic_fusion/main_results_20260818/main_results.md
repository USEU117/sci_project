...
| btad | external_frozen_validation_k1_only | A1 concat (frozen w=0.5) | 0.637341 | 0.07263 | 3/3 | legacy v2 dino score cache (v2_btad_predictions) |
| btad | external_frozen_validation_k1_only | feature-DINO-only KNN | 0.611535 | 0.046824 | 3/3 | legacy v2 dino score cache (v2_btad_predictions) |
| btad | external_frozen_validation_k1_only | A1 concat minus feature-DINO-only |  | 0.025806 | 3/3 | matched feature-level dino-only KNN (concat contribution isolated; CLIP-only not evaluated standalone on BTAD) |
...
- btad/concat: recomputed=0.07263 vs reported=0.07263 (diff 0.0) → PASS
