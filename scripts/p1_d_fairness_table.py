...
ROWS = [
    ...
    {
        "method": "AnomalyDINO",
        "visual_backbone": "DINOv2 (methods/anomalydino, official ViT-L/14)",
        "input_resolution": "official",
        "shot_protocol": "1/2/4-shot; few-shot fine-tuning",
        "training": "yes (few-shot fine-tuned)",
        "target_normal_tuning": "yes (fine-tuning on normal references)",
        "test_time_adaptation": "no",
        "text_in_inference": "no",
        "evaluator": "unified evaluator on project caches",
    ...
    },
    {
        ...
        "input_resolution": "official",
        "shot_protocol": "zero-/one-shot; text-guided",
