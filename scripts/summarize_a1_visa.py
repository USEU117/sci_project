...
def main() -> int:
    ...
    report = {
        ...
        "baseline_source": "feature_level_dino_only_knn (no v2 score cache on this holdout; ~0.001 AP apart from v2 score-level on MPDD s0/k1)",
        "cpu_only_eval": True,
        "overall": {
    ...
    lines = [
        ...
        f"- 数据集: {dataset_name}（holdout，{n_cats} 类，{test_total} 测试图）。",
